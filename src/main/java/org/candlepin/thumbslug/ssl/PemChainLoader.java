 ...
 * PEMChainLoader
 *
 * Read a PEM file full of 1 or more public CA certificates,
 * and create a certificate chain for authenticating a peer's certificate.
 */
class PemChainLoader {

    private PemChainLoader() {
        // for checkstyle
    }

    static X509Certificate[] loadChain(String pem) throws SslPemException {
    ...
    private static List<String> splitPem(String pem) {
        // unfortunately the PEMReader class doesn't seem to let you read multiple
    ...
    private static X509Certificate getX509CertificateFromPem(String pem)
